...
#region SaveDataManagement
        ...
        private void LoadData(string Prefix = "", bool LoadPresets = true)
        {
            ...
            //iOS/tvOS
#if UNITY_5_5_OR_NEWER
            EditorUserBuildSettings.iOSXcodeBuildConfig = (XcodeBuildConfig)DataStore.Get(Prefix + "EditorUserBuildSettings.iOSBuildConfigType", (int)EditorUserBuildSettings.iOSXcodeBuildConfig);
#endif
            //Android
        ...
        private void SaveData(string Prefix = "", bool SavePresets = true)
        {
            ...
            //iOS/tvOS
#if UNITY_5_5_OR_NEWER
            DataStore.Set(Prefix + "EditorUserBuildSettings.iOSBuildConfigType", (int)EditorUserBuildSettings.iOSXcodeBuildConfig);
#endif
            //Android
